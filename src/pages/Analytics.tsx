...
export const Analytics: React.FC = () => {
  ...
  return (
    <div className="space-y-6 w-full text-slate-100">
      ...
      {/* Monthly Timeline */}
      <Card glowColor="none" className="flex flex-col min-h-[350px] bg-white/5 border border-white/5 rounded-2xl p-4 shadow-[0_8px_30px_rgb(0,0,0,0.15)] backdrop-blur-xl">
          ...
          <div className="flex-grow w-full h-[280px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={monthlyData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Legend
                  wrapperStyle={{ fontSize: 9, fontFamily: 'sans-serif', color: '#94A3B8', paddingTop: 12 }}
                  verticalAlign="bottom"
                  height={36}
                />
                <Bar name="Loot (Income)" dataKey="income" fill="url(#incomeGrad)" radius={[6, 6, 0, 0]} maxBarSize={20} />
                <Bar name="Upkeep (Expense)" dataKey="expense" fill="url(#expenseGrad)" radius={[6, 6, 0, 0]} maxBarSize={20} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        )}
